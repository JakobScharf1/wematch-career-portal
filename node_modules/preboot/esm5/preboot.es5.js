...
var EventReplayer = /** @class */ (function () {
    ...
    function (prebootData) {
        ...
        var /** @type {?} */ prebootOverlay = doc.getElementById('prebootOverlay');
        if (prebootOverlay) {
...
EventReplayer.ɵfac = function EventReplayer_Factory(t) { return new (t || EventReplayer)(); };
EventReplayer.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: EventReplayer, factory: function (t) { return EventReplayer.ɵfac(t); } });
...
function start(prebootData, win) {
    ...
    // doesn't affect it.
    var /** @type {?} */ currentScript = _document.currentScript ||
    ...
    var /** @type {?} */ serverNode = currentScript.parentNode;
    if (!serverNode) {
    ...
    // get the root info
    var /** @type {?} */ appRoot = prebootData.opts ? getAppRoot(_document, prebootData.opts, serverNode) : null;
    // we track all events for each app in the prebootData object which is on
    // the global scope; each `start` invocation adds data for one app only.
    var /** @type {?} */ appData = /** @type {?} */ ({ root: appRoot, events: [] });
    if (prebootData.apps) {
...
function getAppRoot(_document, opts, serverNode) {
    var /** @type {?} */ root = { serverNode: serverNode };
...
function handleEvents(_document, prebootData, appData, eventSelector) {
    ...
    eventSelector.events.forEach(function (eventName) {
        ...
        var /** @type {?} */ handler = createListenHandler(_document, prebootData, eventSelector, appData);
...
function createListenHandler(_document, prebootData, eventSelector, appData) {
    ...
    var /** @type {?} */ matches = _document.documentElement.matches ||
        _document.documentElement.msMatchesSelector;
    var /** @type {?} */ opts = prebootData.opts;
    return function (event) {
        var /** @type {?} */ node = event.target;
        ...
        if (opts && !opts.disableOverlay && eventSelector.freeze) {
            var /** @type {?} */ overlay_1 = /** @type {?} */ (root.overlay);
            // show the overlay
            // show the overlay
...
function getInlineDefinition(customOptions) {
    ...
    var /** @type {?} */ initAllStr = initAll.toString();
...
function PREBOOT_FACTORY(doc, prebootOpts, nonce, platformId, appRef, eventReplayer) {
    return function () {
        ...
        if (isPlatformServer(platformId)) {
            var /** @type {?} */ inlineCodeDefinition = getInlineDefinition(prebootOpts);
            var /** @type {?} */ scriptWithDefinition = createScriptFromCode(doc, nonce, inlineCodeDefinition);
            var /** @type {?} */ inlineCodeInvocation_1 = getInlineInvocation();
            var /** @type {?} */ existingScripts = doc.getElementsByClassName(PREBOOT_SCRIPT_CLASS);
            ...
            if (existingScripts.length === 0) {
                var /** @type {?} */ baseList = [];
                var /** @type {?} */ appRootSelectors = baseList.concat(prebootOpts.appRoot);
                ...
                appRootSelectors
                    ...
                    var /** @type {?} */ scriptWithInvocation = createScriptFromCode(doc, nonce, inlineCodeInvocation_1);
...
PrebootModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: PrebootModule });
PrebootModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function PrebootModule_Factory(t) { return new (t || PrebootModule)(); }, providers: [EventReplayer, PREBOOT_PROVIDER] });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PrebootModule, [{
        type: NgModule,
        args: [{
...
export { getNodeKeyForPreboot, PREBOOT_NONCE, _window, EventReplayer, initAll, start, createOverlay, getAppRoot, handleEvents, createListenHandler, getSelection, createBuffer, initFunctionName, defaultOptions, getEventRecorderCode, getInlineDefinition, getInlineInvocation, validateOptions, assign, stringifyWithFunctions, PrebootModule, PREBOOT_FACTORY as ɵb, PREBOOT_OPTIONS as ɵa, PREBOOT_PROVIDER as ɵc };
